...
public class Database implements AutoCloseable {
    ...
    void lockTableMetadata(String tableName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureIXHeld(getTableInfoContext());
    ...
    void lockIndexMetadata(String indexName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockUtil.ensureIXHeld(getIndexInfoContext());
    ...
    private class TransactionContextImpl extends AbstractTransactionContext {
        ...
        public void close() {
            ...
            try {
                List<Lock> locks_copy = new ArrayList<>(Database.this.lockManager.getLocks(this));
                for (int i = locks_copy.size()-1;i >= 0; i--){
                    LockContext.fromResourceName(Database.this.lockManager,locks_copy.get(i).name).release(this);
                }}
            catch (Exception e) {
                e.printStackTrace(); }
        ...
        public void dropAllTables() {
            ...
            try {
                ...
                for (String s : tableNames) {
                    // TODO(proj4_part3): add locking
                    lockTableMetadata(s, LockType.X);
