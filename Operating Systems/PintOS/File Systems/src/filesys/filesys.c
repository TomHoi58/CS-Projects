...
filesys_init (bool format)
{
  ...
  /* -Proj3- The dafault cwd is where the filesys starts. */
  thread_current()->cwd = dir_open_root();
  support_myself_and_parent(dir_open_root(),dir_open_root());
