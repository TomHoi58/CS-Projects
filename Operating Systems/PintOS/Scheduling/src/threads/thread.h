...
struct thread
  {
    ...
    /* -Proj2- Initialize new members of thread for prirority donation. */
...
/* -Proj2- Data structure that stores thread and its wake up time, used for sleeping_threads_list in timer.c */
