...
def eval_all(expressions, env):
    ...
    #     return None
    # P = expressions
    # while P.second is not nil:
    #     scheme_eval(P.first,env)
    #     P = P.second
    # return scheme_eval(P.first, env,True)
...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        <{a: 1, b: 2, c: 3} -> <newly created frame>>
        """
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        if len(formals) != len(vals):
            raise SchemeError('Invalid number of arguments are given')
...
class LambdaProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 12
        "*** YOUR CODE HERE ***"
        new_frame = Frame.make_child_frame(self.env,self.formals,args)
        return new_frame
        # END PROBLEM 12
...
def make_let_frame(bindings, env):
    ...
    # "*** YOUR CODE HERE ***"
    test = bindings
    while test is not nil:
        check_form(test.first,2,2)
        test = test.second
...
class MuProcedure(Procedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # BEGIN PROBLEM 12
        "*** YOUR CODE HERE ***"
        new_frame = Frame.make_child_frame(env,self.formals,args)
        return new_frame
    # END PROBLEM 16
