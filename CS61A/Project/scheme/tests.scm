...
'(+ ,(+ 1 2) 2)
; expect (+ (unquote (+ 1 2)) 2)

,
; expect 
#Actually, the real scheme will give an error for just tying ","

(Begin (+ 3 3) (* 2 2))
; expect 4


(Define x (begin (print 3) (define y 0)))
; expect x

(Define x 0)
; expect x

(Define x (begin (print 3) (define y (/ 1 x))))
; expect Error



(Define x (begin (* 1 2) (print 3)))
; expect x
...
(Define (multiplier x) (define y 2) (* x y))
; expect multiplier
...
(Define (divider x y) (/ x y))
; expect divider

(Divider 20 5)
; expect 4

((Eval (Define (divider x y) (/ x y))) 20 5)
; expect 4

((Lambda (x) (* x x)) 3)
; expect 9

(Define error-maker (lambda (x) (+ x (/ 1 0))))
;expect error-maker
...
(Cond ((> 1 2) 2)((< 2 1) 3) (else))
;expect #t

(Define x 0)
;expect x

(Eval (Cond ((> 1 0) (define x 2))))
;expect 2

(Cond ((> 1 0) 'x-is-not-redefined)(define x 100))
;expect x-is-not-redefined
...
(define g (lambda () (define i 4) (define j 5) (f)))
;expect g
